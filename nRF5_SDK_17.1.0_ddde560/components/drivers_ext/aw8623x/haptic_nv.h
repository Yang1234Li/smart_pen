...
//#define AW_LOGE(format, ...)				printf("[E][haptic_nv][%s]%s: " format "\r\n", g_haptic_nv->mark ,__func__, ##__VA_ARGS__)
//#else
//#define AW_LOGE(format, ...)				printf("[E][haptic_nv]%s: " format "\r\n",__func__, ##__VA_ARGS__)
//#endif
//#else
...
//#ifdef HAPTIC_NV_DOUBLE
//#define AW_LOGI(format, ...)				printf("[I][haptic_nv][%s]%s: " format "\r\n", g_haptic_nv->mark, __func__, ##__VA_ARGS__)
//#else
//#define AW_LOGI(format, ...)				printf("[I][haptic_nv]%s: " format "\r\n", __func__, ##__VA_ARGS__)
//#endif
//#else
...
//#ifdef HAPTIC_NV_DOUBLE
//#define AW_LOGD(format, ...)				printf("[D][haptic_nv][%s]%s: " format "\r\n", g_haptic_nv->mark, __func__, ##__VA_ARGS__)
//#else
//#define AW_LOGD(format, ...)				printf("[D][haptic_nv]%s: " format "\r\n", __func__, ##__VA_ARGS__)
//#endif
//#else
