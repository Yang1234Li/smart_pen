...
static LSM6DSO_Object_t pen_gsensor_lsm6dso;
...
static int32_t lsm6dso_init(void)
{
    return LSM6DSO_OK;
}

static int32_t lsm6dso_deInit(void)
{
    return LSM6DSO_OK;
}
...
static int32_t lsm6dso_write(uint16_t dev_addr, uint16_t reg_addr, uint8_t* data, uint16_t data_len)
{
    lsm6dso_write_reg(NULL, reg_addr, data, data_len);
    return LSM6DSO_OK;
}

static int32_t lsm6dso_read(uint16_t dev_addr, uint16_t reg_addr, uint8_t* data, uint16_t data_len)
{
    lsm6dso_read_reg(NULL, reg_addr, data, data_len);
    return LSM6DSO_OK;
}

void pen_sensor_init(void)
{
